...
const aidnDemandeSeeds: Array<Omit<AidnDemande, 'internalStatus' | 'portalStatus' | 'entryChannel'>> = [
  { id: 'demande-001', reference: 'OMA-2026-001', postulantName: 'Aero Service Gabon', organizationName: 'Aero Service Gabon SARL', submittedAt: '2026-01-08T09:20:00Z', status: 'submitted', requestType: 'Certificat d’agrément OMA', origin: 'guichet_digital', description: 'Soumission initiale en attente de pré-vérification DN.' },
  { id: 'demande-002', reference: 'OMA-2026-002', postulantName: 'Libreville Maintenance', organizationName: 'Libreville Maintenance SA', submittedAt: '2026-01-12T11:35:00Z', status: 'waiting_dg_orientation', requestType: 'Modification de Certificat OMA', origin: 'bureau_courrier', description: 'Courrier physique enregistré et transmis au circuit DG.' },
  { id: 'demande-003', reference: 'OMA-2026-003', postulantName: 'Equateur Aviation', organizationName: 'Equateur Aviation Maintenance', submittedAt: '2026-01-18T08:05:00Z', status: 'oriented_to_dn', requestType: 'Certificat d’agrément OMA', origin: 'email', description: 'Décision DG favorable, dossier DN à consolider.' },
  { id: 'demande-004', reference: 'OMA-2026-004', postulantName: 'Port-Gentil AeroTech', organizationName: 'Port-Gentil AeroTech', submittedAt: '2026-01-23T14:10:00Z', status: 'dn_dossier_opened', requestType: 'Renouvellement de Certificat OMA', origin: 'guichet_digital', description: 'Dossier DN ouvert après orientation favorable.' },
  { id: 'demande-005', reference: 'OMA-2026-005', postulantName: 'Maintenance Nord', organizationName: 'Maintenance Nord Gabon', submittedAt: '2026-02-02T10:50:00Z', status: 'rejected', requestType: 'Certificat de reconnaissance OMA', origin: 'bureau_courrier', description: 'Annulée par DG pour dossier non recevable dans le périmètre MVP.' },
  { id: 'demande-006', reference: 'OMA-2026-006', postulantName: 'Sky Gabon Support', organizationName: 'Sky Gabon Support', submittedAt: '2026-02-08T13:15:00Z', status: 'rejected', requestType: 'Certificat d’agrément OMA', origin: 'email', description: 'Rejetée après avis DG pour dossier non recevable.' },
  { id: 'demande-007', reference: 'OMA-2026-007', postulantName: 'Oyem Air Workshop', organizationName: 'Oyem Air Workshop', submittedAt: '2026-02-15T07:45:00Z', status: 'closed', requestType: 'Modification de Certificat OMA', origin: 'guichet_digital', description: 'Demande clôturée après retrait du postulant.' },
  { id: 'demande-008', reference: 'OMA-2026-008', postulantName: 'National Aero Maintenance', organizationName: 'National Aero Maintenance', submittedAt: '2026-03-01T09:00:00Z', status: 'dn_dossier_opened', requestType: 'Certificat d’agrément OMA', origin: 'bureau_courrier', description: 'Instruction OMA active à la DN.' },
  { id: 'demande-009', reference: 'OMA-2026-009', postulantName: 'Franceville Aviation Services', organizationName: 'Franceville Aviation Services', submittedAt: '2026-03-14T12:25:00Z', status: 'waiting_dg_orientation', requestType: 'Modification de Certificat OMA', origin: 'guichet_digital', description: 'Attente retour DG après transmission.' },
  { id: 'demande-010', reference: 'OMA-2026-010', postulantName: 'Atlantic Aero Gabon', organizationName: 'Atlantic Aero Gabon', submittedAt: '2026-03-22T15:40:00Z', status: 'oriented_to_dn', requestType: 'Renouvellement de Certificat OMA', origin: 'email', description: 'Orientation DN enregistrée, ouverture dossier préparée.' },
];
...
const demandeStatusLayerById: Record<string, { internalStatus: AidnInternalDemandeStatus; portalStatus: AidnPortalStatus; entryChannel: AidnEntryChannel }> = {
  ...
  'demande-005': { internalStatus: 'rejected', portalStatus: 'request_rejected', entryChannel: 'physical_deposit' },
...
export const aidnCourriers: AidnCourrier[] = [
  ...
  { id: 'courrier-002', demandeId: 'demande-002', reference: 'CR-2026-002', mode: 'physical', objet: 'Modification de Certificat OMA', dateDepot: '2026-01-12', scannedAt: '2026-01-12T11:50:00Z', dateEnvoiDg: '2026-01-13', decisionDg: 'pending', scanCourrierUrl: '/mock/courriers/cr-2026-002.pdf' },
  ...
  { id: 'courrier-004', demandeId: 'demande-004', reference: 'CR-2026-004', mode: 'digital', objet: 'Renouvellement de Certificat OMA', dateDepot: '2026-01-23', scannedAt: '2026-01-23T14:25:00Z', dateEnvoiDg: '2026-01-24', dateRetourDg: '2026-01-27', decisionDg: 'oriented_to_dn', directionOrientee: 'Direction de la Navigabilité', scanCourrierUrl: '/mock/courriers/cr-2026-004.pdf' },
  { id: 'courrier-005', demandeId: 'demande-005', reference: 'CR-2026-005', mode: 'physical', objet: 'Certificat de reconnaissance OMA', dateDepot: '2026-02-02', scannedAt: '2026-02-02T11:05:00Z', dateEnvoiDg: '2026-02-03', dateRetourDg: '2026-02-07', decisionDg: 'rejected', scanCourrierUrl: '/mock/courriers/cr-2026-005.pdf' },
...
export const aidnDgDecisionRecords: AidnDgDecisionRecord[] = [
  ...
  { id: 'dg-003', demandeId: 'demande-005', courrierId: 'courrier-005', decision: 'rejected', decidedAt: '2026-02-07T09:10:00Z', notes: 'Dossier non recevable dans le périmètre MVP.', recordedBy: 'Secrétariat DG' },
...
export const aidnDocuments: AidnDocument[] = [
  ...
  { id: 'doc-012', title: 'Notification annulation DG', source: 'dg', status: 'validated', demandeId: 'demande-005', receivedAt: '2026-02-07', updatedAt: '2026-02-07T10:10:00Z' },
...
export const aidnTimelineEvents: AidnTimelineEvent[] = [
  ...
  { id: 'event-002', demandeId: 'demande-002', type: 'courrier_received', label: 'Courrier reçu physiquement', description: 'Modification de certificat déposée au bureau courrier.', occurredAt: '2026-01-12T11:35:00Z', actor: 'Bureau courrier' },
